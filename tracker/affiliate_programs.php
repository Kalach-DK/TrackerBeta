...
<div class="tracker-main">
  ...
  <div class="section" style="margin-bottom:12px">
    <form method="POST" action="/tracker/aff_programs_api.php">
      <label>Name</label>
  ...
  <div class="section">
    <table class="table">
      ...
      <tbody>
<?php
$res = $conn->query("SELECT * FROM affiliate_programs ORDER BY id DESC");
if($res && $res->num_rows){
  while($r = $res->fetch_assoc()){
    echo "<tr>";
    echo "<td>{$r['id']}</td>";
    echo "<td>".htmlspecialchars($r['name'])."</td>";
    echo "<td>".htmlspecialchars(substr($r['api_key'],0,40))."</td>";
